...
<head>
    ...
    <script src="/project1/js/getinfo.js"></script>
    ...
    <link rel="stylesheet" href="/project1/css/getinfo.css">
</head>
<body class='aaa'>
    <?php echo '<hidden id="idfx" value="'.$_POST['userid'].'">' ?>
    <main>
        <div id='contentdiv'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" data-bs-dismiss="modal" <?php ?>>Cancelar</button>
                </div>
                <hidden id="flag">
                <hidden id="alunoid">
            </div>
